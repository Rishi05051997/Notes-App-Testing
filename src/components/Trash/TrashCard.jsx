...
import { deleteNoteFromTrashById, MoveFromTrashToArchive } from "../../services";
        ...
        <div className={`container-card xxl-card-width ${bgColor} mar-md`}>
            ...
            <footer>
                <div className="card-footer text-5 mar-xs pad-xs">
                    <Icon className="iconify cursor_" icon="fluent:delete-28-regular" onClick={() => deleteNoteFromTrashById(dispatch, _id, token)} />
